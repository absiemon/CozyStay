...
export default function PopUp({ bookingId, popUp, setPopUp, placeId, cancel, setCancel }) {
    ...
    const cancelBooking = async () => {
        ...
        setLoading(true);
        await axios.post('/cancel-booking', { bookingId, placeId, selectedReasons }).then((res) => {
            setLoading(false);
            setPopUp(false);
            if (!cancel) {
                setCancel(true);
                                ...
                                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <button className=" bg-primary text-white flex py-1 px-5 rounded-2xl right-20 mt-5 gap-1" onClick={cancelBooking} disabled={loading}>
